                                ...
                                <div class="card-body">
                                    ...
                                    <center><div id="success"></div></center>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 pr-1">
                                                <div class="form-group">
                                                    <input type="hidden" value="<?php echo $Employee_id;?>" name="hdnId" id="hdnId" />
                                                </div>
                                            </div>
                  ...
                  if(Age >= 18 )
                  {
                    if(pass.test(Password))
                    {
                      if(regEx.test(Email))
                      {
                          ...
                          var url = "http://localhost/human_resource_management/1951_php_code/update_employee_details.php";
                          $.ajax({
                             type: "POST",
                              url: url,
                              data: { F_name: F_name, L_name : L_name, Address : Address, Gender : Gender, Contact_no : Contact_no, Age : Age, Password : Password, Email : Email, hdnId: hdnId },
                                success: function(data)
                                {
                                  if(data == 1)
                                  {
                                      $('#success').html("Employee updated successfully");
                                        setTimeout(function()
                                        { 
                                            window.location = 'http://localhost/human_resource_management/1951_php_code/employee_profile.php';
                                        }, 3000);
                                  }
                                  else if(data == 2)
                                  {
